...
class Base:
    ...
    def clean_data(self):
        columns = [
            'fees', 'latLong', 'entrancePasses', 'directionsInfo',
            'directionsUrl', 'addresses', 'weatherInfo', 'name', 'contacts'
            ]
        ...
        name_change = [
            {'fullName': 'full_name'}, {'parkCode': 'park_code'},
        ...
        # Cleaning the states column. Separating the strings of multiple 
        # states into a list.
        s_list = []
